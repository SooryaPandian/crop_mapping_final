...
input_files = [
    os.path.join(input_dir, f"VV_timeseries_{project_name}_crops3inc.csv"),
    os.path.join(input_dir, f"VH_timeseries_{project_name}_crops3inc.csv"),
    os.path.join(input_dir, f"NDVI_timeseries_{project_name}_crops3inc.csv")
]
